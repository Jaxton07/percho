...
export const en: Messages = {
	...
	interaction: {
		...
		hintSelect: "↑↓ select · Enter confirm · Esc cancel",
		hintInput: "Enter submit · Esc cancel",
		hintEditor: "⌘Enter submit · Esc cancel",
		hintConfirm: "Enter yes · Esc no",
		hintPermission: "Enter {allowOnce} · A {always} · Esc {deny}",
		hintPermissionDir: "Enter {allowOnce} · A {always} · D {dir} · Esc {deny}",
		timedOutNote: 'Times out to "cancel" if unanswered',
		prefillNote: 'Extension "{source}" filled the draft',
	},
	permission: {
		deny: "Deny",
	...
	// 与 zh.ts 同形；markstream 内置 UI 文案（Preview/Source/Copy/Close…）由这里覆盖
	mermaid: {
	...
	sidebar: {
		...
		removeProjectDesc:
			"This deletes all {count} sessions under this project in Percho; the project files on your computer stay untouched.",
		removeProjectDescEmpty:
	...
	toast: {
		...
		overflowCollapsed: "{count} more collapsed · duplicates merged",
