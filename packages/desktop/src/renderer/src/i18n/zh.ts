...
export const zh = {
	...
	// mermaid 图表卡（components/chat/MermaidBlock.tsx）：renderFailed = 失败态卡片标题，
	// 其余同时覆盖 markstream 内置 UI 文案（Preview/Source/Copy/Close 等，走它自己的全局字典）
	mermaid: {
		renderFailed: "图表渲染失败",
		rendering: "渲染中…",
		preview: "预览",
	...
	sidebar: {
		...
		removeProjectDesc: "这会把 Percho 中该项目下的 {count} 个会话一并删除；你电脑上的项目文件不受影响。",
